...
{
	public CoinSpannable(final MonetaryFormat format, final boolean signed, @Nullable final Coin coin)
	{
		super(format(format, signed, coin));
	}

	public CoinSpannable(final MonetaryFormat format, @Nullable final Coin coin)
	{
